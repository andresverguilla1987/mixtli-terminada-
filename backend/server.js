// Backend Mixtli v2 (SQLite + Rate limit + Cleanup + trust proxy)
...
try { fs.mkdirSync(DATA_DIR, { recursive: true }); } catch (e) { console.warn('[warn] no se pudo crear DATA_DIR:', DATA_DIR, e.message); }
